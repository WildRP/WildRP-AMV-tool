...
public partial class BoundsMesh : MeshInstance3D
{
    [Export] protected Color _color = Colors.Firebrick;
    [Export] protected Node3D _planesNode;
    [Export] protected PackedScene _boundsPlaneScene;
    
    private ImmediateMesh _mesh;
    private StandardMaterial3D _material;
    
    private Volume _parentVolume;
    ...
    public override void _Ready()
    {
        ...
        _parentVolume = GetParent<Volume>();
